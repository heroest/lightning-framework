 ...
 */
final class ExtUvLoop implements AwaitableLoopInterface
{
    private $uv;
    ...
    public function __construct()
    {
        ...
        $this->streamEvents = new ArrayObject();
    ...
    public function run()
    {
        ...
        while ($this->running) {
            ...
            $nothingLeftToDo = $this->readStreams->isEmpty()
                && $this->writeStreams->isEmpty()
                && (0 === $this->timers->count())
