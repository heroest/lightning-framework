 ...
 */
final class ExtEventLoop implements AwaitableLoopInterface
{
    private $eventBase;
    ...
    private $readEvents = null;
    private $writeEvents = null;
    private $readListeners = null;
    private $writeListeners = null;
    private $readRefs = null;
    private $writeRefs = null;
    private $running;
    private $signals;
    ...
    public function __construct()
    {
        ...
        $this->readEvents = new ArrayObject();
        $this->writeEvents = new ArrayObject();
